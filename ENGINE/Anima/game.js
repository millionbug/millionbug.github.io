(function (factory) {
    if (typeof module === 'object' && typeof module.exports === 'object') {
        ...
        define(["require", "exports", "../FrameState", "../Frame", "../Frame", "../Frame"], factory);
    }
    ...
    //定义动画
    var anims = new Frame_3.Animation();
    //帧控制器
    var fCtrl = null;
    //时钟句柄
    var tHand = null;
    ...
    function start(e) {
        ...
        if (btnS.value === "开始") {
            FrameState_1.FrameState.start(); //开启帧数追踪
            //更新帧状态
            tHand = setInterval(function () {
                FrameState_1.FrameState.update();
